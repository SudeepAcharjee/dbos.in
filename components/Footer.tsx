...
export default function Footer() {
  return (
    <footer className={`${primaryPurple} border-t border-white/10`}>
      <div className="mx-auto max-w-7xl px-4 py-10 text-sm text-slate-200">
        <div className="grid gap-10 md:grid-cols-3 lg:grid-cols-[minmax(0,1.4fr)_minmax(0,1fr)_minmax(0,1fr)]">
          ...
          <div className="space-y-4">
            ...
            <p className="max-w-md text-xs text-slate-100/90">
          ...
          {/* Programs */}
          <div className="space-y-3">
            <h3 className="text-sm font-semibold text-yellow-300">Our Programs</h3>
            <ul className="space-y-2 text-xs">
              <li>
